...
const divBy = require('operators/divBy')
...
const remBy = require('operators/remBy')
const sub = require('operators/sub')
const subBy = require('operators/subBy')
...
describe('operators index', () => {
  it('provides all of the exported operators', () => {
    ...
    expect(divBy).to.equal(index.divBy)
    ...
    expect(remBy).to.equal(index.remBy)
    expect(sub).to.equal(index.sub)
    expect(subBy).to.equal(index.subBy)
  })
})
