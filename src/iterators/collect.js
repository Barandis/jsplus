 ...
 *
 * **`collect` is not lazy.** It will evaluate an entire iterator and is thus not suitable
...
function collect(x) {
  ...
  // of the iteration, checking, and reducing that would otherwise be involved.
