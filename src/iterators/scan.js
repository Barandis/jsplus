 ...
 * @param {*} x The collection to scan. This can be of any type; a non-iterable value will
 *      be transformed into an array containing only that value.
 * @returns {iterator} An iterator containing each of the return values of the reducer
 *      function `fn`.
