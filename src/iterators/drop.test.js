...
describe('take', () => {
  it('returns a subset of an iterable', () => {
    ...
    expect(array(result)).to.deep.equal([4, 5])
  })
  it('works with strings', () => {
    const result = drop(3)('testing')
    expect(reduce(add)(result)).to.equal('ting')
  })
  it('works with iterators', () => {
    const result = drop(3)(upTo5())
    expect(array(result)).to.deep.equal([3, 4, 5])
  })
  ...
  it('works with functions', () => {
    ...
    expect(array(result)).to.deep.equal([3, 4])
  })
